...
- 检查 Web 服务是否正常（资源已本地化至 `/static` 目录）
- 清除浏览器缓存并刷新
...
- ✅ **连接增强**：支持显示设备型号 (Device Model)
- ✅ **状态优化**：在 System Check 显示连接方式 (USB/Wireless)
- ✅ **控制增强**：无线连接支持一键断开 (Disconnect) 和动态 UI 禁用
- ✅ **修复 Bug**：过滤并排除 offline 状态设备
- ✅ **资源本地化**：Tailwind, Fonts, Marked.js 全量本地化，支持离线环境
