...
- 🎨 **现代化 UI** - 暗色主题、可调整布局、实时日志流、**全量本地化资源**
...
- ✅ **连接增强**：实时显示设备型号 (Device Model)
- ✅ **状态感知**：智能识别 USB/无线连接方式
- ✅ **无线控制**：新增无线 ADB 断开连接功能，动态置灰不可用控件
- ✅ **稳定性提升**：自动过滤 offline 状态设备
- ✅ **离线支持**：TailwindCSS、Inter 字体、Marked.js 全面本地化，无网络环境加载秒开
